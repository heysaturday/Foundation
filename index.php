...
<div id="wrapper">
  ...
  <div class="clearfix"><ul id="pagination" class="pagination">
        ...
        <!-- <li onclick="slideshow.pos(3)">4</li> -->
         ...
         <p>For more information on Julie’s Pink Warrior Project contact Lee Ann Thomas at (910)577-2651 or <a href="mailto:leeann.thomas@onslow.org" target="_blank">leeann.thomas@onslow.org.</a></p><br>
